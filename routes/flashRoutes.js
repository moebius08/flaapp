...
const { showCurrentLevel, levelUp, increment, getAllLessons } = require('../controllers/flashCtrl')
...
router.patch('/add', checkToken, increment)
...
router.get('/getLesson', checkToken, getAllLessons) // level id babato
    // router.post('/lesson-complete', checkToken, completeLesson) // lesson id babato
